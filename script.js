...
if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
    ...
    // document.writeln("<style>body{margin:0;}</style><div style='width:100%;height:100%;background-color:black;'><img style='width:30%;margin-left:auto;margin-right:auto;margin-top:auto;margin-bottom:auto;display:block;' src='ar.png'></div>");
    document.writeln("<style>body{margin:0;}</style><div style='width:100%;height:100%;background-color:black;'><img style='width:1000;position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);' src='ar.png'></div>");
    // window.stop();
}
